...
@app.route('/')
def home():
    return '''<h1>Welcome to Food Names API</h1> <a href="https://github.com/Zenomodiff/Random-Food-Names-API" target="blank">Documentation</a>'''


@app.route('/api/Food-Names/all', methods=['GET'])
def api_all():
